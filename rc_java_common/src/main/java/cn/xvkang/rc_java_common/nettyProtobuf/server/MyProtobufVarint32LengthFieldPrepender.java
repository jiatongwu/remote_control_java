...
/**
 * An encoder that prepends the Google Protocol Buffers <a href=
 * "https://developers.google.com/protocol-buffers/docs/encoding?csw=1#varints">Base
